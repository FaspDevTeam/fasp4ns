                                         ...
                                         REAL *u)
{
    ...
    // initialize matrix
    matA11.row = *nA; matA11.col = *nA; matA11.nnz = *nnzA;
    matA11.IA  = ia;  matA11.JA  = ja;  matA11.val = aval;

    matA12.row = *nB; matA12.col = *mB; matA12.nnz = *nnzB;
    matA12.IA  = ib;  matA12.JA  = jb;  matA12.val = bval;
                                         ...
                                         REAL *u)
{
    ...
    matA21.row = *nB; matA21.col = *nA; matA21.nnz = *nnzB;
    matA21.IA  = ib;  matA21.JA  = jb;  matA21.val = bval;
