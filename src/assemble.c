 ...
 * \brief assemble stiffness matrix *ptr_A and righ hand side *ptr_b for uniform grid (gridnum by gridnum).
 *
...
int assemble(block_dCSRmat *ptr_A, dvector *ptr_b, int gridnum)
{
	...
	idenmat elem; // triangulation: store 3 points and 3 edges corresponding to the element in each row
